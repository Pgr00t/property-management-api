...
class TestUnitAPI:
    ...
    def test_list_units_with_filter(self, api_client):
        prop = Property.objects.create(name='P1', address='A1')
        Unit.objects.create(property=prop, unit_number='101', monthly_rent='1000', status='available')
        Unit.objects.create(property=prop, unit_number='102', monthly_rent='1000', status='occupied')
